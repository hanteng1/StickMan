function Pcharts(idofChart, idvalueofchart, idofTable) {
    ...
    var data_colors = [
                        ...
                        "#C36241", "#C35817", "#CC6600", "#E66C2C", "#F87431", "#FF8040",  //color for item 5
                        "#810541", "#7E354D", "#7F4E52", "#7F5A58", "#C5908E", "#E8ADAA"   //color for item 6
                        ];
    ...
    function update() {
        ...
        if(pchart_scope.running_state == false)
        {
            return;
        }
